...
ActiveRecord::Schema.define(version: 2023_01_09_063519) do
  ...
  create_table "select_answers", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.jsonb "multiple_answers", default: [], array: true
  ...
  create_table "summary_tracks", force: :cascade do |t|
    t.bigint "account_id"
  ...
  create_table "time_tracks", force: :cascade do |t|
    ...
    t.index ["company_id"], name: "index_time_tracks_on_company_id"
  end
  ...
  add_foreign_key "time_tracks", "companies"
